## Welcome to Chris Pages

You can use the [editor on GitHub](https://github.com/chris-kenobi/kenobi-test/edit/master/index.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/chris-kenobi/kenobi-test/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
...
<script type="text/javascript">
          (function(){
            ...
            useriq.identify(user_id, {
              ...
              account_name: 'ACME',
              user_email: 'chris+100@useriq.com',
